        ...
        match direction {
            "U" => {
                for i in 0..num_loop_max {
                    ...
                    if i == num_i64 {
                        self.wire_head =
                            (self.wire_head.0, self.wire_head.1 + i, self.wire_head.2 + i);
                    }
                }
            }
            "D" => {
            ...
            "L" => {
                for i in 0..num_loop_max {
                    ...
                    if i == num_i64 {
                        self.wire_head =
                            (self.wire_head.0 - i, self.wire_head.1, self.wire_head.2 + i);
                    }
                }
            }
            "R" => {
...
impl Problem for Day03 {
    fn part_one(&mut self, _input: &str) -> String {
        let mut contents: String = common::read_file_to_string("2019/three_input.txt");
    ...
    fn part_two(&mut self, _input: &str) -> String {
        let mut contents: String = common::read_file_to_string("2019/three_input.txt");
        let mut indices_to_remove: Vec<usize> = Vec::new();
